...
namespace pdima88\phpassets;

/**
 * Small asset manager for PHP v1.0
 * (https://github.com/pdima88/phpassets)
 *
 * Copyright 2017-2019 Puchkin Dmitriy
 *
 * Licensed under MIT
 * (https://github.com/pdima88/phpassets/blob/master/LICENSE)
 */
...
class Assets {
    static $libs = [
        ...
        'vue' => [
            'debug' => 'https://cdnjs.cloudflare.com/ajax/libs/vue/2.5.16/vue.js',
            'prod' => 'https://cdnjs.cloudflare.com/ajax/libs/vue/2.5.16/vue.min.js'
        ],
    ];
    ...
    protected function _styleToString(&$style) {
        ...
        if (is_array($style)) {
            ...
            return $css->css();
        } elseif (is_a($style, '\\pdima88\\phpassets\\Style')) {
            return $style->css();
        }
    ...
    /**
     * Returns {@see Css} helper object for building style
     * You can add style from this helper object with {@see Assets::addStyle} method
     * or {@see Css::save save} method inside helper object
     * @return Css
     */
